...
TRANSLATIONS: dict[str, dict[str, str]] = {
    LANG_EN: {
        ...
        "Открыть…": "Open…",
        "Выход": "Quit",
        # Задачи #216/#217: сохранить как / экспорт спектра
        ...
        "Анализ": "Analysis",
        "Инструменты": "Tools",
        "Вид": "View",                    # #MENU-2: новое верхнее меню (замена «Инструменты»)
        "Сервис": "Service",
        "Помощь": "Help",
        "Справка": "Help",                # #MENU-2: новое верхнее меню (замена «Помощь»)
        "О программе": "About",
        "Фон": "Background",              # #MENU-3: подменю «Анализ»
        "Пики": "Peaks",                  # #MENU-3
        "Эффективность": "Efficiency",    # #MENU-3
        "Библиотека нуклидов": "Nuclide library",   # #MENU-2: перенос из «Изотопы»
        "Идентификация по найденным пикам": "Identification by found peaks",
        # Задача #182: пункты внутри меню «Помощь» и «О программе»
        "Справка…": "Help…",
        "О программе…": "About…",
        ...
        # Задача #CI-1: голые ключи «Высота»/«Площадь» сохраняются для test_i18n_peaks_strings.
        "Высота": "Height",
        ...
        "Сегмент": "Segment",
        "кэВ": "keV",
        # Задача #183: единицы приблизительной шкалы counts на секущих плоскостях (view3d.plane_value)
        "отсч/с (≈)": "cnt/s (≈)",
        "отсч. (≈)": "cnt (≈)",
        ...
        "мЗв/ч": "mSv/h",
        "мкЗв/ч": "µSv/h",
        # Отчёт целостности (Задача #UI-236)
        "Отчёт целостности…": "Integrity report…",
        "Отчёт о целостности": "Integrity report",
        "=== Отчёт о целостности данных ===": "=== Data integrity report ===",
        "Всего отсчётов": "Total counts",
        "Длительность записи": "Recording duration",
        "Контроль целостности: недоступен (формат без CRC32)":
            "Integrity control: unavailable (format has no CRC32)",
        "CRC32: OK": "CRC32: OK",
        "проверено строк": "rows checked",
        "CRC32: ПОВРЕЖДЕНО СТРОК": "CRC32: CORRUPT ROWS",
        ...
        "Мощность дозы, мкЗв/ч": "Dose rate, µSv/h",
        ...
        # --- #I18N-1: вкладка «Прибор» и диалог калибровки (2026-08-20) ---
        "Калибровка": "Calibration",
        "Калибровка по пикам": "Peak-based calibration",
        "Текущая калибровка": "Current calibration",
        "Пресет:": "Preset:",
        "— выберите —": "— select —",
        "Добавить строки": "Add rows",
        "Добавить строки с истинными энергиями пресета (канал заполните сами)": "Add rows with the preset true energies (fill in the channel yourself)",
        "Из найденных пиков…": "From found peaks…",
        "Взять каналы и энергии из окна «Найденные пики»; истинную энергию впишите": "Take channels and energies from the \"Found peaks\" window; type in the true energy",
        "Нуклиды:": "Nuclides:",
        "Подобрать E ▼": "Suggest E ▼",
        "Ближайшие линии активных нуклидов для выбранной строки": "Nearest lines of active nuclides for the selected row",
        "E тек., кэВ": "E current, keV",
        "E истинная, кэВ": "E true, keV",
        "+ строка": "+ row",
        "− удалить": "− remove",
        "Очистить": "Clear",
        "Степень:": "Degree:",
        ...
        "Применить": "Apply",
        "RMSE": "RMSE",
        "Ошибка фита": "Fit error",
        "Нужно >=2 корректных пар.": "At least 2 valid pairs are required.",
        "Порт:": "Port:",
        "Обновить": "Refresh",
        ...
        "Нет порта": "No port",
        "Выберите COM-порт.": "Select a COM port.",
        "Статус прибора": "Device status",
        "Состояние:": "State:",
        "Время прибора:": "Device time:",
        "Свипов / дропов:": "Sweeps / drops:",
        "Запись .aswf": ".aswf recording",
        "Запись не ведётся": "Not recording",
        "Запись…": "Recording…",
        ...
        "Папка:": "Folder:",
        "Нет папки": "No folder",
        "Папка для записи .aswf": "Folder for .aswf recording",
        "Выберите папку для записи.": "Select a folder for recording.",
        "(не выбрана)": "(not selected)",
        "GPS": "GPS",
        "CRC32 OK": "CRC32 OK",
        "CRC32 пропущен (сжатый)": "CRC32 skipped (compressed)",
        "CRC32: повреждено строк": "CRC32: corrupted rows",
        # --- #I18N-1: вкладка «Прибор» и диалог калибровки (2026-08-20) ---
        "Калибровка по пикам…": "Peak-based calibration…",
        # --- #I18N-1: вкладка «Прибор» и диалог калибровки (2026-08-20) ---
        "Гамма-1С (NaI 63×63, 15 см)": "Gamma-1S (NaI 63×63, 15 cm)",
    },
}
